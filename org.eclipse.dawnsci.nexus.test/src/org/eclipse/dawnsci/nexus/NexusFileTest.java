...
public class NexusFileTest {
	...
	public void testAddExternalLinkNode() throws Exception {
		...
		/*
		ExternalNode ed = new ExternalNodeImpl("/g/ed".hashCode(), FILE2_NAME, "/ext/data", true);
		ExternalNode eg = new ExternalNodeImpl("/g/eg".hashCode(), FILE2_NAME, "/ext/group/", false);
		/*/
		SymbolicNode ed = new SymbolicNodeImpl("/g/ed".hashCode(), FILE2_NAME, "/ext/data");
		SymbolicNode eg = new SymbolicNodeImpl("/g/eg".hashCode(), FILE2_NAME, "/ext/group/");
		//*/
		g.addNode("ed", ed);
		g.addNode("eg", eg);
		nf.addNode("/g", g);
